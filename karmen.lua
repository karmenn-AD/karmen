...
io.popen("cd library && wget https://raw.githubusercontent.com/karmen-AD/karmen/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/karmen-AD/Files_karmen/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevkarmenW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevkarmenW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevkarmenW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevkarmenW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevkarmenW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevkarmenW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevkarmenW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1821190716) then  
var = true  
...
--------------------------------------------------------------------------------------------------------------
function Sourcekarmen(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'كارمن')
...
local list = database:smembers(bot_id.."karmen1:List:Filter"..sl)
...
if not DevkarmenW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevkarmenW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌯' and DevkarmenW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevkarmenW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevkarmenW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevkarmenW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevkarmenW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevkarmenW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevkarmenW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevkarmenW(msg) then 
os.execute('rm -rf karmen.lua')
os.execute('wget https://raw.githubusercontent.com/karmen-AD/karmen/main/karmen.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس كارمن*\n*⌯︙الاصدار » { 2.8v}*')
dofile('karmen.lua')  
end
if text == 'الاصدار ⌯' and DevkarmenW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس كارمن* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevkarmenW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/tttttuiopk) \n⌯︙[قناه السورس](t.me/tttttuiopk)')
end
if text == "ضع اسم للبوت ⌯" and DevkarmenW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevkarmenW(msg) then 
...
if text == 'المشتركين ⌯' and DevkarmenW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevkarmenW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevkarmenW(msg) then
...
if text == ("قائمه العام ⌯") and DevkarmenW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevkarmenW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevkarmenW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevkarmenW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevkarmenW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevkarmenW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevkarmenW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevkarmenW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevkarmenW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevkarmenW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..karmenk..''..karmen..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevkarmenW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevkarmenW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevkarmenW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevkarmenW(msg) then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevkarmenW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevkarmenW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevkarmenW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevkarmenW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevkarmenW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevkarmenW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevkarmenW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevkarmenW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevkarmenW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."karmen:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."karmen:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_karmen = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_karmen then 
names_karmen = database:smembers(bot_id.."karmen:blocname"..msg.chat_id_) or ""
if names_karmen and names_karmen[1] then 
for i=1,#names_karmen do 
if name_karmen:match("(.*)("..names_karmen[i]..")(.*)") then 
...
database:set(bot_id.."karmen:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."karmen:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."karmen:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."karmen:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."karmen:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_karmena_new(karmen1,karmen2)
if karmen2 and karmen2.first_name_ then 
if karmen2.first_name_:match("(.*)"..database:get(bot_id.."karmen:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."karmen:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local karmen_nnn = database:get(bot_id.."karmen:nump"..msg.chat_id_) or 5
local karmen_nnn2 = database:get(bot_id.."karmen:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(karmen_nnn2) == tonumber(karmen_nnn) or tonumber(karmen_nnn2) > tonumber(karmen_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."karmen:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..karmen2.username_.."](https://t.me/"..(karmen2.username_ or "tttttuiopk")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."karmen:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(karmen_nnn) - tonumber(karmen_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_karmena_new)
end
end
...
local karmenChengName = database:get(bot_id.."karmen:Cheng:Name"..data.id_)
if not data.first_name_ then 
if karmenChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..karmenChengName..']')
database:del(bot_id.."karmen:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if karmenChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."karmen:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local karmenChengUserName = database:get(bot_id.."karmen:Cheng:UserName"..data.id_)
if not data.username_ then 
if karmenChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..karmenChengUserName..']')
database:del(bot_id.."karmen:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if karmenChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."karmen:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local karmenChengPhoto = database:get(bot_id.."karmen:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if karmenChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."karmen:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if karmenChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."karmen:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴀsᴅ\n\n[⌯  ᴀsᴅ ᴄʜᴀɴɴᴇʟ](http://t.me/tttttuiopk)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/tttttuiopk)\n\n[⌯  ᴀsᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/K_k_k_ksa)\n\n[⌯  ʙᴏᴛ ᴀsᴅ](http://t.me/Mohammed91_bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ ᴀsᴅ',url="t.me/tttttuiopk"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevkarmenW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevkarmenW(msg) then
dofile('karmen.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevkarmenW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevkarmenW(msg) then  
function start_function(extra, result, success)
if karmenSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevkarmenW(msg) then  
...
if karmenSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevkarmenW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if karmenSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevkarmenW(msg) then  
function start_function(extra, result, success)
if karmenSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevkarmenW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevkarmenW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if karmenSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevkarmenW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevkarmenW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevkarmenW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevkarmenW(msg) then
...
if text == 'الملفات' and DevkarmenW(msg) then
...
if DevkarmenW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/karmen-AD/Files_karmen/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevkarmenW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/karmen-AD/Files_karmen/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevkarmenW(msg) then
...
if text == "مسح الملفات" and DevkarmenW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevkarmenW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevkarmenW(msg) then  
function start_function(extra, result, success)
...
function Function_karmen(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_karmen, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_karmen, nil)
return false 
end
...
local TEXT_SUD = database:get(bot_id..'karmen:TEXT_SUDO')
if TEXT_SUDO then 
...
if text == 'مسح كليشه المطور' and DevkarmenW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevkarmenW(msg) then
...
if text == 'تفعيل الاذاعه' and DevkarmenW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevkarmenW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevkarmenW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,karmen)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝐾𝐴𝑅𝑀𝐸𝑁 ━━━━━━━•*\n"
x = 0
...
if karmenSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevkarmenW(msg) then 
...
if text == ("ردود المطور") and DevkarmenW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝐾𝐴𝑅𝑀𝐸𝑁 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevkarmenW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevkarmenW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كارمن').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevkarmenW(msg) then   
...
if text == 'تعطيل المغادره' and DevkarmenW(msg) then  
...
if text == 'استعاده الاوامر' and DevkarmenW(msg) then
...
{{text = ' 𝐾𝐴𝑅𝑀𝐸𝑁 𝑇𝐸𝐴𝑀 ↻', url="t.me/tttttuiopk"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ 𝐾𝐴𝑅𝑀𝐸𝑁 ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[ 𝐾𝐴𝑅𝑀𝐸𝑁 𝑇𝐸𝐴𝑀 ↻](t.me/tttttuiopk) ')
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴀsᴅ',url='http://t.me/tttttuiopk'}},
}
